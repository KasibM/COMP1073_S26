...
class Mocha extends Coffee {
    chocolateCoffeeRatio;
    constructor(size, isDecaf, chocolateCoffeeRatio) {
        super(size, isDecaf);
        this.chocolateCoffeeRatio = chocolateCoffeeRatio;
    }
    mochaDesc() {
        return `A ${this.size} Mocha, made with ${this.chocolateCoffeeRatio} hot chocolate`;
    }
}
// Instantiate at least 2 objects from new Mocha subclass
let kasibMocha = new Mocha("medium", false, "50%");
let kasib2Mocha = new Mocha("large", true, "30%");

// Call serveIt method on new Mocha object
kasibMocha.serveIt();
// Create new paragraph element
let kasibMochaDesc = document.createElement("p"); // <p> 
// Set paragraph textContent to mochaDesc description method return value
kasibMochaDesc.textContent = kasibMocha.mochaDesc();
//Append new paragraph to output element
output.appendChild(kasibMochaDesc);

// Call serveIt method on new Mocha object
kasib2Mocha.serveIt();
// Create new paragraph element
let kasib2MochaDesc = document.createElement("p"); // <p> 
// Set paragraph textContent to mochaDesc description method return value
kasib2MochaDesc.textContent = kasib2Mocha.mochaDesc();
//Append new paragraph to output element
output.appendChild(kasib2MochaDesc);